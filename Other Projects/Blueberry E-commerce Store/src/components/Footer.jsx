      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <span className="text-white text-xl font-bold">Blue</span>
                <span className="text-neutral-300 text-xl font-bold">Berry</span>
              </div>
            </div>
            <p className="text-neutral-400 text-sm mb-4">
              Your trusted partner for fresh groceries, delivered right to your doorstep. Quality products at the best prices.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 bg-neutral-700 rounded-full flex items-center justify-center hover:bg-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/categories" className="text-neutral-400 hover:text-white transition-colors">Shop</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-neutral-400 hover:text-white transition-colors">Track Order</a></li>
              <li><a href="#" className="text-neutral-400 hover:text-white transition-colors">Returns</a></li>
              <li><a href="#" className="text-neutral-400 hover:text-white transition-colors">Shipping Info</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-neutral-400">
                ...
                <span>123 Market Street, Surat, Gujarat, India</span>
              </li>
              <li className="flex items-center gap-2 text-neutral-400">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>support@blueberry.com</span>
              </li>
              <li className="flex items-center gap-2 text-neutral-400">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-neutral-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <img src="https://upload.wikimedia.org/wikipedia/commons/0/04/Visa.svg" alt="Visa" className="h-8 opacity-70" />
            <img src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Mastercard-logo.svg" alt="Mastercard" className="h-8 opacity-70" />
            <img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/American_Express_logo_%282018%29.svg" alt="Amex" className="h-8 opacity-70" />
          </div>
        </div>
      </div>
    </footer>
